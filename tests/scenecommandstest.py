...
class SceneCommandsTest(unittest.TestCase):
    ...
    #
    # def testPutNavigationCommand(self):
    #     PutNavigationCommand(self.database_path, 'scene-001', 'scene-002').do()

    def testPutPropCommand(self):
        pass

    def testPutCharacterCommand(self):
        pass
    ...
    def testGetPropCommand(self):
        pass

    def testGetCharacterCommand(self):
        pass
