...
class SceneCommandsTest(unittest.TestCase):
    ...
    def testSceneCommands(self):
        ...
        SetSceneCommand(self.database_path, scene1).do()
        ...
        SetSceneCommand(self.database_path, scene2).do()
        ...
        SetNavigationCommand(self.database_path, 'scene-001', 'scene-002', 'south', 'north').do()
        ...
        SetPropCommand(self.database_path, prop1, 'scene-001').do()
        ...
        SetCharacterCommand(self.database_path, character1, 'scene-001').do()
        ...
        SetCharacterCommand(self.database_path, character2, 'scene-001').do()
