...
from engine.store.commands.getassociations import GetAssociationsCommand
...
class GetAssociationGroupsCommand:
    ...
    def do(self):
        ...
        for association in associations:
            resolved_topic_refs = self.__resolve_topic_refs(association)
    ...
    def __resolve_topic_refs(self, association):
        topic_refs = []
