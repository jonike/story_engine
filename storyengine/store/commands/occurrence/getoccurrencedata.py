"""
GetOccurrenceData class. Part of the StoryTechnologies Builder project.
...
class GetOccurrenceData:
    ...
    def do(self):
        ...
        try:
            cursor.execute("SELECT resource_data FROM occurrence WHERE identifier = ?", (self.identifier,))
