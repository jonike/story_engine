...
class SetProp:
    ...
    def do(self):
        ...
        SetAttributes(self.database_path, self.map_identifier, [location_attribute, rotation_attribute, scale_attribute]).do()
        ...
        SetAssociation(self.database_path, self.map_identifier, association).do()
